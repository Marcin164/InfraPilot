...
export const REPORTS: ReportMeta[] = [
  ...
  { key: 'security-bitlocker-compliance', category: 'security', chart: 'pie',
    title: 'BitLocker compliance', description: 'Devices with BitLocker enabled vs disabled',
    fn: security.devicesBitlockerComplianceReport },
