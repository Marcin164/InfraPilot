...
``collect_event_log`` / ``inventory_refresh`` / ``custom`` work. The agent
is expected to claim queued tasks, run them, and report back -- this module
is that side of the contract.
"""
